...
public static class DefaultInputBindings
{
    ...
    public static IReadOnlyList<InputBindingDefinition> Create()
    {
        var result = new List<InputBindingDefinition>
        {
            ...
            Bind("camera.move_up", InputContextId.Camera, "UP"),
            Bind("camera.move_down", InputContextId.Camera, "DOWN"),
            Bind("camera.move_left", InputContextId.Camera, "LEFT"),
            Bind("camera.move_right", InputContextId.Camera, "RIGHT"),
            Bind("camera.rotate_clockwise", InputContextId.Camera, "R"),
            Bind("camera.rotate_counterclockwise", InputContextId.Camera, "E"),
            Bind("camera.focus_latest_event", InputContextId.Camera, "SPACE"),
            Bind("selection.select_all", InputContextId.Selection, "Q"),
            Bind("selection.select_same_type", InputContextId.Selection, "W"),
            ...
            Bind("unit.attack_move", InputContextId.UnitCommand, "A"),
            Bind("unit.stop", InputContextId.UnitCommand, "S"),
