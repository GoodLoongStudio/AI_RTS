...
func build_report() -> Dictionary:
	...
	var report := {
		...
		"map": {
			"name": map_ctx.get("name", null),
			"path": map_ctx.get("path", null),
			"seed": map_ctx.get("seed", null),
			"size": map_ctx.get("size", null),
			"players": map_ctx.get("players", null),
		},
		"mode": context.get("mode", null),
		"difficulty": context.get("difficulty", null),
		"duration_seconds": duration,
		"outcome": outcome,
		"victory_condition": context.get("victory_condition", null),
